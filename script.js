...
// دالة لتواصل مع الوكيل لإضافة رصيد بدلاً من الإضافة التلقائية
function requestBalanceUpdate() {
    const message = "يرجى التواصل مع الوكيل لإضافة الرصيد.";
    alert(message); // التنبيه للمستخدم بأن عليه التواصل مع الوكيل
}
